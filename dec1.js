let report = [1337, 1906, 2007, 1939, 818, 1556, 2005, 1722, 1484, 1381, 1682, 1253, 1967, 1718,
    2002,
    1398,
    1439,
    1689,
...
function sumOf2020(array, twentyTwenty){
    for(let i = 0; i < array.length -1; i++){
        for(let a = i +1; a < array.length; a++){
            if(array[i] + array[a] === twentyTwenty){
                console.log(array[i] + " and " + array[a] + " add to 2020.")
